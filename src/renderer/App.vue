<template>
  <div>
    <mu-appbar title='Title'>
      <mu-flat-button class='quantaxislogo' href='/'  color='white' style='-webkit-app-region: drag'
      ...
      <mu-popover :trigger='trigger' :open='open' @close='handleClose'>
          <mu-menu >
            ...
            <router-link to='/personal/index'>
              <mu-list-item title='个人中心'></mu-list-item>
            </router-link>
            <router-link to='/personal/block'>
              <mu-list-item title='版块监控'></mu-list-item>
            </router-link>
